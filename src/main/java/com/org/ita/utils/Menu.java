...
public class Menu {
    ...
    private final String[] optionsAllCommands = new String[] { "Show all users", "Set user implementation and run task",
	    "Show tasks" };
    private final String[] nameTasksEigth = new String[] { "KeepHydrated", "VolumeOfCuboid", "MpgToKpm",
	    "SquareOrSquareRoot", "CountPositivesSumNegatives", "ConvertAStringToANumber", "AmIWilson",
	    "TwoDecimalPlaces", "DivisibleBy" };
    private final String[] nameTasksSeven = new String[] { "LookingForABenefactor", "SeriesSum", "WhereIsHe" };
    private final String[] nameTasksSix = new String[] { "FindNB", "Balance", "F", "Rainfall", "NbaCup",
	    "HelpTheBookseller" };
    private final String[] nameTasksFive = new String[] { "ArtificialRain", "Gap", "Zeros", "Perimeter", "SolveSum",
	    "Smallest" };
